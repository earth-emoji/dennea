# Generated by Django 2.2.12 on 2020-06-10 00:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('photos', '0002_auto_20200609_0617'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'predefined attribute value',
            },
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('acl', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='users.Acl')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='attributes', to='catalog.Product')),
                ('selected_values', models.ManyToManyField(related_name='selected_values', to='catalog.PredefineAttributeValue')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='attribute',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='predefined_values', to='catalog.ProductAttribute'),
        ),
    ]
